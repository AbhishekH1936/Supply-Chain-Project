...
handleSubmit = e => {
      ...
      if (formValid(this.state)) 
      {
        ...
        if(ret){
          let signup_info = {
            ...
            "Cold Storage":this.state.c_storage,
  ...
  handleChange = e => {
    ...
    this.setState({ formErrors, [name]: value }, () => console.log("name:values",this.state));
  };
        ...
        <div className="form-wrapper">
          ...
          <form onSubmit={this.handleSubmit} noValidate>
            ...
            <div className="c_storage">
            	...
            	<div>
		       	<input className="l2" type="radio" value="Yes" name="c_storage" 
		       	onChange={this.handleChange}
		       	/> Yes
		        <input className="l2" type="radio" value="No" name="c_storage"  
		        onChange={this.handleChange}
		        /> No
		        </div>
    	   </div>
